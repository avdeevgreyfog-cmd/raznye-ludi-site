...
if(!document.querySelector('script[data-scout-monitoring-v1]')){const m=document.createElement('script');m.dataset.scoutMonitoringV1='1';m.src='monitoring-v1.js?v=1';m.onload=()=>{try{window.ScoutMonitoring?.refresh?.()}catch(e){console.error('MONITORING_RENDER',e)}};m.onerror=()=>console.error('MONITORING_LOAD_FAILED');document.body.appendChild(m)}
})();
