...
(() => {
  ...
  const ICONS={
    ...
    roles:'<circle cx="8.5" cy="7.5" r="2.4"/><path d="M4.2 17.5c.35-3.2 2.1-5 4.3-5 1.35 0 2.45.55 3.2 1.55"/><circle cx="16.7" cy="15.6" r="2.1"/><path d="M16.7 11.9v1M16.7 18.2v1M13 15.6h1M20.2 16h1M14.1 13l.7.7M18.6 17.5l.7.7M19.3 13l-.7.7M14.8 17.5l-.7.7"/>',
